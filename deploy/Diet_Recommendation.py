...
class Display:
    def __init__(self):
        self.plans=["Maintain weight (Duy trì cân nặng)","Mild weight loss (Giảm cân nhẹ)","Weight loss (Giảm cân)","Extreme weight loss (Giảm cân nhiều)"]
...
with st.form("recommendation_form"):
    ...
    number_of_meals=st.slider('Meals per day (Số bữa ăn mỗi ngày)',min_value=3,max_value=5,step=1,value=3)
